 ...
 */
public class BossActiPriceSearchAdapter extends BaseAdapter {

	private List<String> list;
	private LayoutInflater inflater;

	public BossActiPriceSearchAdapter(Context context, List<String> list) {
		this.list = list;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(
					R.layout.item_boss_acti_price_search, null);
