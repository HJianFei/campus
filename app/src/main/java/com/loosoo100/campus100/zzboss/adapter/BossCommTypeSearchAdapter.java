 ...
 */
public class BossCommTypeSearchAdapter extends BaseAdapter {

	private List<CampusInfo> list;
	private LayoutInflater inflater;

	public BossCommTypeSearchAdapter(Context context, List<CampusInfo> list) {
		this.list = list;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.item_boss_comm_type_search, null);
