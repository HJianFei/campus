...
/**
 * 
 * @author yang 弹出的活动支付选择界面
 */
public class BossPayChoiceActivity extends Activity implements OnClickListener {
	...
	private Handler handlerTogetherPay = new Handler() {
		public void handleMessage(android.os.Message msg) {
			if (payWay == 0) {
				WXPayUtil wp = new WXPayUtil(BossPayChoiceActivity.this, "act1"
						+ seedOid, cuid, "loosoo100", "", money);
				wp.sendPay();
			} else if (payWay == 1) {
				alipayUtil = new AlipayUtil(BossPayChoiceActivity.this,
						"loosoo100", "校园100", money + "", cuid, seedOid, "act1");
				alipayUtil.pay();
				isPaying = true;
				new Thread() {
					public void run() {
	...
	public void onClick(View v) {
		...
		case R.id.ll_wallet:
			seedOid = "0";
//			Intent payIntent1 = new Intent(BossPayChoiceActivity.this,
...
//			startActivity(payIntent1);
		...
		case R.id.ll_weixin:
			...
			new Thread() {
				@Override
				public void run() {
					getActiOrderId(MyConfig.URL_POST_COMM_ACTI_PAY_OTHER);
				}
			}.start();
			break;
		...
		case R.id.btn_recharge:
			Intent rechargeIntent = new Intent(BossPayChoiceActivity.this,
...
//			Intent payIntent2 = new Intent(BossPayChoiceActivity.this,
//					BossPayActivity.class);
		...
		httpUtils.send(HttpRequest.HttpMethod.POST, uploadHost, params,
				new RequestCallBack<String>() {
					...
					public void onSuccess(ResponseInfo<String> responseInfo) {
						...
						if (seedOid.equals("0")) {
							ToastUtil.showToast(BossPayChoiceActivity.this,"提交失败");
						} else {
