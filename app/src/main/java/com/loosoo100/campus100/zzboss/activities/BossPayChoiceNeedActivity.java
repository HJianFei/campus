...
/**
 * 
 * @author yang 弹出的需求支付选择界面
 */
public class BossPayChoiceNeedActivity extends Activity implements OnClickListener {
	...
	private Handler handlerTogetherPay = new Handler() {
		public void handleMessage(android.os.Message msg) {
			if (payWay == 0) {
				WXPayUtil wp = new WXPayUtil(BossPayChoiceNeedActivity.this, "need"
						+ seedOid, cuid, "loosoo100", "", money);
				wp.sendPay();
			} else if (payWay == 1) {
				alipayUtil = new AlipayUtil(BossPayChoiceNeedActivity.this,
						"loosoo100", "校园100", money + "", cuid, seedOid, "need");
				alipayUtil.pay();
				isPaying = true;
				new Thread() {
					public void run() {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_pay_choice_need);
	...
	public void onClick(View v) {
		...
		case R.id.ll_wallet:
			seedOid = "0";
//			Intent payIntent1 = new Intent(BossPayChoiceNeedActivity.this,
...
//			startActivity(payIntent1);
		...
		case R.id.ll_weixin:
			...
			new Thread() {
				@Override
				public void run() {
					getActiOrderId(MyConfig.URL_POST_COMM_NEED_PAY_OTHER);
				}
			}.start();
			break;
		...
		case R.id.btn_recharge:
			Intent rechargeIntent = new Intent(BossPayChoiceNeedActivity.this,
					BossCashInActivity.class);
			startActivity(rechargeIntent);
			break;

		// 支付返回按钮
		case R.id.rl_back_pay:
//			Intent payIntent2 = new Intent(BossPayChoiceNeedActivity.this,
//					BossPayNeedActivity.class);
		...
		httpUtils.send(HttpRequest.HttpMethod.POST, uploadHost, params,
				new RequestCallBack<String>() {
					...
					public void onSuccess(ResponseInfo<String> responseInfo) {
						...
						if (seedOid.equals("0")) {
							ToastUtil.showToast(BossPayChoiceNeedActivity.this,"提交失败");
						} else {
