 ...
 * 
 */
public class BossCommController extends BaseController implements OnClickListener {
	...
	public BossCommController(Context context) {
		super(context);
...
//		}.start();
	...
	protected View initView(Context context) {
		...
		return inflater.inflate(R.layout.controller_boss_message_comm, null);
	}
