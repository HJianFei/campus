...
/**
 * 
 * @author yang 需求报名人员activity
 */
public class BossCommNeedMemJoinActivity extends Activity implements
		OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_comm_need_mem_join);
		...
		new Thread() {
			...
			public void run() {
				list = GetData
						.getCommNeedMemJoinInfos(MyConfig.URL_JSON_NEED_LIST_BOSS
								+ did);
				if (!isDestroyed()) {
