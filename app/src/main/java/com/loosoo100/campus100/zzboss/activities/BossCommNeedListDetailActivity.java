...
/**
 * 
 * @author yang 社团需求赞助详情activity
 */
public class BossCommNeedListDetailActivity extends Activity implements
		OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_comm_need_together_detail);
		...
		new Thread() {
			...
			public void run() {
				list = GetData
						.getCommSupportInfos(MyConfig.URL_JSON_NEED_LIST_BOSS
								+ did);
				if (!isDestroyed()) {
