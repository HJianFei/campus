...
/**
 * 
 * @author yang 活动支持ta支付activity
 */
public class BossCommJoinPayActivity extends Activity implements
		OnClickListener {
	...
	private Handler handlerPay = new Handler() {
		public void handleMessage(android.os.Message msg) {
			Intent intent = new Intent(BossCommJoinPayActivity.this,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_boss_comm_support_pay);
	...
	public void onClick(View v) {
		...
		case R.id.btn_ok:
			...
			if (money.equals("")) {
				ToastUtil.showToast(BossCommJoinPayActivity.this,"请输入金额");
				return;
			}
			payMoney = Float.valueOf(money);
			if (payMoney <= 0) {
				ToastUtil.showToast(BossCommJoinPayActivity.this,"金额不能为0");
				return;
			}
				...
				new RequestCallBack<String>() {
					...
					public void onSuccess(ResponseInfo<String> responseInfo) {
						...
						if (result.equals("0")) {
							...
							BossCommJoinPayActivity.this.finish();
						}
					}
					...
					public void onFailure(HttpException arg0, String arg1) {
						...
						ToastUtil.showToast(BossCommJoinPayActivity.this,"支付失败");
						progress_update_blackbg.setVisibility(View.GONE);
					}
				});
	}
		...
		httpUtils.send(HttpRequest.HttpMethod.POST, uploadHost, params,
				new RequestCallBack<String>() {
					...
					public void onSuccess(ResponseInfo<String> responseInfo) {
						...
						if (result.equals("-4")) {
							ToastUtil.showToast(BossCommJoinPayActivity.this,"请先设置支付密码");
							Intent intent = new Intent(
									BossCommJoinPayActivity.this,
