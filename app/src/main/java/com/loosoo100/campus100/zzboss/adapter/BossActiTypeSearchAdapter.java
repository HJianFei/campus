 ...
 */
public class BossActiTypeSearchAdapter extends BaseAdapter {

	private List<CampusInfo> list;
	private LayoutInflater inflater;

	public BossActiTypeSearchAdapter(Context context, List<CampusInfo> list) {
		this.list = list;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.item_boss_acti_type_search, null);
		...
		viewHolder.tv_name.setText(list.get(position).getCampusName());
