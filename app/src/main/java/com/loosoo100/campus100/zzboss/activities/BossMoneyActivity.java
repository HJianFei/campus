...
import com.loosoo100.campus100.activities.MoneyInstructionActivity;
 ...
 */
public class BossMoneyActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_boss_money);
		...
		new Thread() {
			public void run() {
				list = GetData
						.getBossConsumeInfos(MyConfig.URL_JSON_CONSUME_HISTORY_BOSS
	...
	public void onClick(View v) {
		...
		case R.id.ll_explain:
			Intent moneyIntent = new Intent(this,
					MoneyInstructionActivity.class);
			startActivity(moneyIntent);
			break;

		case R.id.rl_cashout:
			Intent outIntent = new Intent(this, BossCashOutActivity.class);
			startActivity(outIntent);
			break;

		case R.id.rl_cashin:
			Intent inIntent = new Intent(this, BossCashInActivity.class);
