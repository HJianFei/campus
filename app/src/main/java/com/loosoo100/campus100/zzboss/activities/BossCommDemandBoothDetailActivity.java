 ...
 * @author yang 社团需求详情
 */
public class BossCommDemandBoothDetailActivity extends Activity implements
    ...
    private Handler handlerPay = new Handler() {
        public void handleMessage(android.os.Message msg) {
            Intent intentPay = new Intent(
                    BossCommDemandBoothDetailActivity.this,
                    BossPayNeedActivity.class);
            intentPay.putExtra("money",
                    Float.valueOf(commSupportInfo.getFree()));
            intentPay.putExtra("aid", did);
            intentPay.putExtra("cid", commSupportInfo.getCommId());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_boss_comm_demand_booth_detail);
                ...
                if (commSupportInfo.getFlag()==0) {
                    ...
                    builder.setPositiveButton("是",
                            new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    Intent intent = new Intent(BossCommDemandBoothDetailActivity.this,
                    ...
                    ToastUtil.showToast(BossCommDemandBoothDetailActivity.this, "请等待企业审核通过后再联系社团");
                } else if (commSupportInfo.getFlag()==2) {
                    //启动会话界面
                    if (RongIM.getInstance() != null) {
                        RongIM.getInstance().startPrivateChat(BossCommDemandBoothDetailActivity.this, commSupportInfo.getCommUid(), commSupportInfo.getCommName());
                    }
                } else {
                    ToastUtil.showToast(BossCommDemandBoothDetailActivity.this, "网络异常，请稍候再试");
                }
                break;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == RESULT_OK && requestCode == 1) {
            ...
            new Thread() {
                public void run() {
                    postData(MyConfig.URL_POST_COMM_NEED_PAY_BOSS);
                }
                ...
                new RequestCallBack<String>() {
                    ...
                    public void onSuccess(ResponseInfo<String> responseInfo) {
                        ...
                        if (result.equals("1") || result.equals("2")) {
                            ...
                            progress_update_blackbg.setVisibility(View.GONE);
                            ToastUtil.showToast(BossCommDemandBoothDetailActivity.this, "您权限不足");
                        } else {
                            progress_update_blackbg.setVisibility(View.GONE);
                            if (!isDestroyed()) {
                    ...
                    public void onFailure(HttpException arg0, String arg1) {
                        ...
                        progress_update_blackbg.setVisibility(View.GONE);
                        ToastUtil.showToast(BossCommDemandBoothDetailActivity.this, "操作失败");
                    }
                });
    }
    ...
    private void postData(String uploadHost) {
        ...
        params.addBodyParameter("cid", commSupportInfo.getCommId());
        params.addBodyParameter("classifyid", commSupportInfo.getClassify()
                + "");
        params.addBodyParameter("money", commSupportInfo.getFree());
        params.addBodyParameter("uid", cuid);
        httpUtils.send(HttpRequest.HttpMethod.POST, uploadHost, params,
                new RequestCallBack<String>() {
                    @Override
        ...
        httpUtils.send(HttpRequest.HttpMethod.POST, uploadHost, params,
                new RequestCallBack<String>() {
                    ...
                    public void onSuccess(ResponseInfo<String> responseInfo) {
                        ...
                        if (result.equals("-4")) {
                            ToastUtil.showToast(BossCommDemandBoothDetailActivity.this, "请先设置支付密码");
                            Intent intent = new Intent(
                                    BossCommDemandBoothDetailActivity.this,
