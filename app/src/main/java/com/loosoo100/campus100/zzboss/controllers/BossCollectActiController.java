 ...
 * 
 */
public class BossCollectActiController extends BaseController {
	...
	public BossCollectActiController(Context context) {
		super(context);
	...
	protected View initView(Context context) {
		...
		return inflater.inflate(R.layout.controller_boss_collect_acti, null);
	}
