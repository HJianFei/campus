...
/**
 * @author yang 需求参与支付activity
 */
public class BossCommNeedPayActivity extends Activity implements
        OnClickListener {
    ...
    private Handler handlerPay = new Handler() {
        public void handleMessage(android.os.Message msg) {
            Intent intent = new Intent(BossCommNeedPayActivity.this,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_boss_comm_need_pay);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_ok:
                ...
                if (money.equals("")) {
                    ToastUtil.showToast(BossCommNeedPayActivity.this, "请输入金额");
                    return;
                }
                payMoney = Float.valueOf(money);
                if (payMoney <= 0) {
                    ToastUtil.showToast(BossCommNeedPayActivity.this, "金额不能为0");
                    return;
                }
        ...
        httpUtils.send(HttpRequest.HttpMethod.POST, uploadHost, params,
                new RequestCallBack<String>() {
                    ...
                    public void onSuccess(ResponseInfo<String> responseInfo) {
                        ...
                        if (result.equals("0")) {
                            EventBus.getDefault().post(
                                    new MEventCommNeedPay(true));
                            BossCommNeedPayActivity.this.finish();
                        }
                    }
                    ...
                    public void onFailure(HttpException arg0, String arg1) {
                        ...
                        ToastUtil.showToast(BossCommNeedPayActivity.this, "支付失败");
                        progress_update_blackbg.setVisibility(View.GONE);
                    }
                });
    }
        ...
        httpUtils.send(HttpRequest.HttpMethod.POST, uploadHost, params,
                new RequestCallBack<String>() {
                    ...
                    public void onSuccess(ResponseInfo<String> responseInfo) {
                        ...
                        if (result.equals("-4")) {
                            ToastUtil.showToast(BossCommNeedPayActivity.this, "请先设置支付密码");
                            Intent intent = new Intent(
                                    BossCommNeedPayActivity.this,
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == RESULT_OK && requestCode == 1) {
            ...
            progress_update_blackbg.setVisibility(View.GONE);
            EventBus.getDefault().post(new MEventCommNeedPay(true));
            BossCommNeedPayActivity.this.finish();
        }
