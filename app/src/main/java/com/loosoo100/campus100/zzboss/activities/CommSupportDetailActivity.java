...
/**
 * 
 * @author yang 社团活动打赏情况activity
 */
public class CommSupportDetailActivity extends Activity implements
		OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_boss_comm_together_detail);
		...
		new Thread() {
			...
			public void run() {
				list = GetData
						.getCommSupportInfos(MyConfig.URL_JSON_ACTI_REWARD
								+ aid);
				if (!isDestroyed()) {
