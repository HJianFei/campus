...
import com.loosoo100.campus100.activities.LoginPWUpdateActivity;
import com.loosoo100.campus100.activities.NickNameActivity;
 ...
 */
public class BossUserOrAddressActivity extends Activity implements
		OnClickListener {
...
//	private LinearLayout ll_company; // 我的公司
...
//	private LinearLayout ll_telephone; // 电话布局
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_boss_user_address);
...
//			if (identi) {
//				intent.setClass(this, BossCompanySummaryActivity.class);
//				startActivity(intent);
//			} else {
//				intent.setClass(this, CompanyNameEditActivity.class);
//				startActivity(intent);
//			}
//			break;
		case R.id.ll_basicInfo:
			intent.setClass(this, BossBasicInfoActivity.class);
			startActivity(intent);
			break;
...
//						new Thread() {
//							public void run() {
//								postData(MyConfig.URL_POST_HEADSHOT_BOSS,
		...
		httpUtils.send(HttpRequest.HttpMethod.POST, uploadHost, params,
				new RequestCallBack<String>() {
					...
					public void onSuccess(ResponseInfo<String> responseInfo) {
						...
						if (result.equals("1")) {
							ToastUtil.showToast(BossUserOrAddressActivity.this,"头像修改成功");
						} else if (result.equals("0")) {
							ToastUtil.showToast(BossUserOrAddressActivity.this,"操作失败");
						}
					}
