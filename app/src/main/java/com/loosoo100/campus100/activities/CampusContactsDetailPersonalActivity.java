...
/**
 * 
 * @author yang 校园圈详情个人activity
 * 
 */
public class CampusContactsDetailPersonalActivity extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_campus_contacts_detail_personal);
					...
					public void onClick(View v) {
						...
						if (campusContactsInfo != null) {
							clipboardManager.setText(campusContactsInfo
									.getContent());
							ToastUtil.showToast(CampusContactsDetailPersonalActivity.this,"已复制");
						}
						dialogCopy.dismiss();
					}
				});
	...
	private void initView() {
		...
		// 判断是否属于自己的
		if (!campusContactsInfo.getUserId().equals(uid)) {
		...
		gv_picture.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent intent = new Intent(
						CampusContactsDetailPersonalActivity.this,
		...
		lv_appraise.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				et_content.setText("");
				// 显示软键盘
				MyUtils.showSoftInput(
						CampusContactsDetailPersonalActivity.this, et_content);
			}
		});
	...
	public void onClick(View v) {
			...
			builderSure.setPositiveButton("是",
					new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface dialog, int which) {
							...
							new Thread() {
								public void run() {
									postDeleteAll(MyConfig.URL_POST_CAMPUS_DELETE
											+ campusContactsInfo.getId());
								};
							}.start();
						}
					});
		...
		case R.id.iv_dialog:
			...
			if (ll_appraise_up.getVisibility() == View.VISIBLE) {
				...
				ll_appraise_up.startAnimation(MyAnimation
						.getScaleAnimationToRight());
			} else if (ll_appraise_up.getVisibility() == View.GONE) {
		...
		case R.id.ll_like:
			if (campusContactsInfo.getIsLiked() == 0) {
				...
				ToastUtil.showToast(CampusContactsDetailPersonalActivity.this,"您已赞过了");
			}
			ll_appraise_up.setVisibility(View.GONE);
			ll_appraise_up.startAnimation(MyAnimation
					.getScaleAnimationToRight());
		...
		case R.id.ll_appraise:
			...
			ll_appraise_up.startAnimation(MyAnimation
					.getScaleAnimationToRight());
			// 显示软键盘
			MyUtils.showSoftInput(CampusContactsDetailPersonalActivity.this,
					et_content);
			break;
		...
		case R.id.btn05:
			...
			btn_ok.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					if (content.equals("")) {
						ToastUtil.showToast(CampusContactsDetailPersonalActivity.this,"请输入举报内容");
						return;
					}
					dialog.dismiss();
					progress_update_blackbg.setVisibility(View.VISIBLE);
				...
				new RequestCallBack<String>() {
					...
					public void onSuccess(ResponseInfo<String> responseInfo) {
						...
						if (!result.equals("0") && !result.equals("-1")) {
							...
							ToastUtil.showToast(CampusContactsDetailPersonalActivity.this,"评论失败");
						}
					}
	 ...
	 * @param uploadHost
	 */
	private void postDeleteAll(String uploadHost) {
		HttpUtils httpUtils = new HttpUtils();
		httpUtils.send(HttpRequest.HttpMethod.GET, uploadHost,
				new RequestCallBack<String>() {
					...
					public void onSuccess(ResponseInfo<String> responseInfo) {
						...
						EventBus.getDefault().post(
								new MEventCampusContactsAllDel(true,
										campusContactsInfo.getId()));
						Intent intent = new Intent(
								CampusContactsDetailPersonalActivity.this,
								CampusContactsPersonalActivity.class);
						startActivity(intent);
						CampusContactsDetailPersonalActivity.this.finish();
					}
					...
					public void onFailure(HttpException arg0, String arg1) {
						LogUtils.d("arg1",arg1.toString());
						progress_update_blackbg.setVisibility(View.GONE);
						ToastUtil.showToast(CampusContactsDetailPersonalActivity.this,"操作失败");
					}
				});
	}
	...
	public boolean onTouch(View v, MotionEvent event) {
		...
		if (ll_appraise_edit.getVisibility() == View.VISIBLE) {
			ll_appraise_edit.setVisibility(View.GONE);
			// 隐藏软键盘
			MyUtils.hideSoftInput(CampusContactsDetailPersonalActivity.this,
					et_content);
		}
		return false;
	}
				...
				new RequestCallBack<String>() {
					...
					public void onSuccess(ResponseInfo<String> responseInfo) {
						...
						if (result.equals("0")) {
							...
							ToastUtil.showToast(CampusContactsDetailPersonalActivity.this,"您已举报过了");
						} else {
							ToastUtil.showToast(CampusContactsDetailPersonalActivity.this,"举报成功");
						}
					}
