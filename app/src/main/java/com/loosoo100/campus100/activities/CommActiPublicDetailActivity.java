 ...
 * @author yang
 */
public class CommActiPublicDetailActivity extends Activity implements
		OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_publish_comm_acti_detail);
		...
		tv_wordCount.setText(summary.length() + "/800");
	...
	private void initView() {
		...
		et_summary.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence s, int start, int before,
					int count) {
				tv_wordCount.setText(s.length() + "/800");
			}
				...
				builderDel.setPositiveButton("是",
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,
									int which) {
								CommActiPublicDetailActivity.this.finish();
							}
						});
			...
			public boolean onItemLongClick(AdapterView<?> parent, View view,
				...
				if (position == (list_path == null ? 0 : list_path.size())) {// 点击“+”号位置添加图片
					...
					CustomDialog.Builder builder = new CustomDialog.Builder(
							CommActiPublicDetailActivity.this);
