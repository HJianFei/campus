...
/**
 * 
 * @author yang 社团爱心公益筹activity
 */
public class CommunityHeartActivity extends Activity implements OnClickListener {
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if (list.get(position).getClassify() == 0) {
					Intent intent = new Intent(CommunityHeartActivity.this,
