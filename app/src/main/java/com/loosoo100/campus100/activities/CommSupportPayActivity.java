 ...
 */
public class CommSupportPayActivity extends Activity implements OnClickListener {
	...
	private Handler handlerPay = new Handler() {
		public void handleMessage(android.os.Message msg) {
			Intent intent = new Intent(CommSupportPayActivity.this,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_comm_reward_pay);
				...
				new RequestCallBack<String>() {
					...
					public void onSuccess(ResponseInfo<String> responseInfo) {
						...
						if (result.equals("0")) {
							...
							CommSupportPayActivity.this.finish();
						}
					}
					...
					public void onFailure(HttpException arg0, String arg1) {
						...
						ToastUtil.showToast(CommSupportPayActivity.this,"支付失败");
						progress_update_blackbg.setVisibility(View.GONE);
					}
				});
	}
		...
		httpUtils.send(HttpRequest.HttpMethod.POST, uploadHost, params,
				new RequestCallBack<String>() {
					...
					public void onSuccess(ResponseInfo<String> responseInfo) {
						...
						if (result.equals("-4")) {
							ToastUtil.showToast(CommSupportPayActivity.this,"请先设置支付密码");
							Intent intent = new Intent(
									CommSupportPayActivity.this,
