...
import com.loosoo100.campus100.chat.fragment.ContactsFragment;
import com.loosoo100.campus100.chat.widget.AddFriendPopWindow;
...
public class MessageFragment extends Fragment implements OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.add_friend:
                AddFriendPopWindow addFriendPopWindow = new AddFriendPopWindow(getActivity());
                addFriendPopWindow.showPopupWindow(add_friend);
    ...
    private void initViewPager() {
        ...
        fragments.add(new ContactsFragment().newInstance("contact", "contact"));
        ...
        vp.setOnPageChangeListener(new OnPageChangeListener() {
            ...
            public void onPageSelected(int arg0) {
                if (arg0 == 0) {
                    ...
                    btn_friend.setTextSize(14);
                    iv_whiteline.startAnimation(translateAnimation(1));
                    x = width;
                } else {
                    btn_friend.setTextSize(16);
