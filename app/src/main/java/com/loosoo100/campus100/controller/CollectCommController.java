 ...
 * 
 */
public class CollectCommController extends BaseController {
	...
	public CollectCommController(Context context) {
		super(context);
	...
	public void initData() {
		...
		new Thread() {
			public void run() {
				list = GetData
						.getMyCollectInfos(MyConfig.URL_JSON_MYCOLLECT_ACTI
								+ uid);
	...
	protected View initView(Context context) {
		...
		return inflater.inflate(R.layout.controller_collect_comm, null);
	}
