...
import com.loosoo100.campus100.adapters.InviteCommAdapter;
 ...
 * @author yang
 */
public class InviteCommController extends BaseController {
    ...
    private InviteCommAdapter adapter;
    ...
    public InviteCommController(Context context) {
        super(context);
    ...
    public void initData() {
        ...
        new Thread() {
            public void run() {
                list = GetData
                        .getInviteCommInfos(MyConfig.URL_JSON_AGENTLIST
                                + "?uid=" + uid + "&type=1");
                count = GetData
    ...
    protected View initView(Context context) {
        ...
        return inflater.inflate(R.layout.controller_invite_comm, null);
    }

    private void initListView() {
        adapter = new InviteCommAdapter(activity, list);
        ...
        listView.setOnScrollListener(new OnScrollListener() {
            ...
            public void onScroll(AbsListView view, int firstVisibleItem,
                ...
                if (firstVisibleItem + visibleItemCount == totalItemCount
                    ...
                    new Thread() {
                        public void run() {
                            List<CommunityBasicInfo> list2 = GetData
                                    .getInviteCommInfos(MyConfig.URL_JSON_AGENTLIST
                                            + "?uid=" + uid + "&type=1" + "&page=" + page);
