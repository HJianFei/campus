...
import com.loosoo100.campus100.activities.OverseasDetailActivity;
 ...
 * 
 */
public class CollectOverseasController extends BaseController {
	...
	public CollectOverseasController(Context context) {
		super(context);
	...
	public void initData() {
		...
		new Thread() {
			public void run() {
				list = GetData
						.getMyCollectInfos(MyConfig.URL_JSON_MYCOLLECT_OVERSEAS
								+ uid);
	...
	protected View initView(Context context) {
		...
		return inflater.inflate(R.layout.controller_collect_overseas, null);
	}
