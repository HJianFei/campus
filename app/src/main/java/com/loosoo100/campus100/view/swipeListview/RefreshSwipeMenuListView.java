package com.loosoo100.campus100.view.swipeListview;
...
public class RefreshSwipeMenuListView extends ListView implements
		OnScrollListener {
	...
	private boolean mEnablePullRefresh = false;// 能否下拉刷新
	...
	/**
	 * enable or disable pull up load more feature. 设置加载可用
	 * 
	 * @param enable
	 */
	...
	/**
	 * stop refresh, reset header view. 停止刷新,重置头部控件
	 */
	...
	/**
	 * stop load more, reset footer view. 停止加载更多,重置尾部控件
	 */
