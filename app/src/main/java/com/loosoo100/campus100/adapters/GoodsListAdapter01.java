...
import com.loosoo100.campus100.utils.ParabolaAnimation;
 ...
 * @author yang 商品列表适配器
 */
public class GoodsListAdapter01 extends BaseAdapter {

	public static List<GoodsInfo> list;
	private LayoutInflater inflater;
	private ViewHolder viewHolder = null;
	private HomeActivity activity;
	private ParabolaAnimation animation;

	public GoodsListAdapter01(Context context, List<GoodsInfo> list) {
		this.list = list;
		activity = (HomeActivity) context;

		inflater = LayoutInflater.from(context);
		
		animation=new ParabolaAnimation(context);
...
//					animation.setAnim(startLocation,endView);// 开始执行动画
					// 设置商品是否是添加状态
					...
					GoodsListAdapter01.this.notifyDataSetChanged();
				} else {
