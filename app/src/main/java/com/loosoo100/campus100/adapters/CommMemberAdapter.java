 ...
 * @author yang 社团成员适配器
 */
public class CommMemberAdapter extends BaseAdapter {
	...
	public CommMemberAdapter(Context context, List<CommunityMemberInfo> list,
			boolean showName) {
		this.list = list;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.item_comm_member, null);
