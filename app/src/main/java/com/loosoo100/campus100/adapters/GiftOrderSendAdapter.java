...
import com.loosoo100.campus100.activities.GiftOrderSendActivity;
...
/**
 * @author yang 礼物说送出订单适配器
 */
public class GiftOrderSendAdapter extends BaseAdapter {
    ...
    public GiftOrderSendAdapter(Context context, List<GiftOrderInfo> list) {
        this.list = list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.btn_pay.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                GiftOrderSendActivity.mPosition = position;
//                GiftOrderSendActivity.orderId = list.get(position).getOrderID();
                ...
                new RequestCallBack<String>() {
                    ...
                    public void onSuccess(ResponseInfo<String> responseInfo) {
                        ...
                        if (result.equals("1")) {
                            ...
                            GiftOrderSendAdapter.this.notifyDataSetChanged();
                        } else if (result.equals("0")) {
                            ToastUtil.showToast(activity, "操作失败");
                        }
                        EventBus.getDefault().post(
                                new MEventGiftSendOrder(false));
                    }
