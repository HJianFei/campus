...
import com.loosoo100.campus100.activities.GiftSendActivity;
...
public class GiftOrderAdapter extends BaseAdapter {
    ...
    private GiftOrderActivity activity;

    private int mPosition;

    public GiftOrderAdapter(Context context, List<GiftOrderInfo> list) {
        this.list = list;

        activity = (GiftOrderActivity) context;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            // ll_persent,progressBar,tv_persent
		 ...
		 * 不是凑一凑订单
		 */
        if (list.get(position).getNeedType() != 2) {
		 ...
		 */
            ...
            // viewHolder.tv_time.setTextColor(activity.getResources().getColor(
            // R.color.red_fd3c49));
            viewHolder.ll_persent.setVisibility(View.VISIBLE);
...
//					viewHolder.btn_cancel.setVisibility(View.VISIBLE);
                ...
                builder.setPositiveButton("是",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog,
                                                int which) {
                                EventBus.getDefault().post(new MEventGiftOrder(true));
                                new Thread() {
                                    public void run() {
        ...
        viewHolder.btn_pay.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                GiftOrderActivity.mPosition = position;
        ...
        viewHolder.btn_send.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                mPosition = position;
                Intent intent = new Intent(activity, GiftSendActivity.class);
        ...
        httpUtils.send(HttpRequest.HttpMethod.GET, uploadHost,
                new RequestCallBack<String>() {
                    ...
                    public void onSuccess(ResponseInfo<String> responseInfo) {
                        ...
                        EventBus.getDefault().post(new MEventGiftOrder(false));
                        String result = "";
                        try {
                        ...
                        if (result.equals("1")) {
                            ...
                            GiftOrderAdapter.this.notifyDataSetChanged();
                ...
                new RequestCallBack<String>() {
                    ...
                    public void onSuccess(ResponseInfo<String> responseInfo) {
                        ...
                        if (result.equals("1")) {
                            ...
                            list.get(mPosition).setStatus(2);
                            GiftOrderAdapter.this.notifyDataSetChanged();
                            ToastUtil.showToast(activity, "操作成功");
                        } else if (result.equals("0")) {
                            ToastUtil.showToast(activity, "操作失败");
