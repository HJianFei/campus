 ...
 */
public class HListViewAdapterHome extends BaseAdapter {

	private List<GoodsInfo> list;
	private LayoutInflater inflater;


	public HListViewAdapterHome(Context context, List<GoodsInfo> list) {
		this.list = list;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.item_gallery_home, null);
