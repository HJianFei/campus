 ...
 * @author yang 商品分类适配器
 */
public class GiftCategoryAdapter extends BaseAdapter {
	...
	public GiftCategoryAdapter(Context context, List<CategoryInfo> list) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.item_category_gift, null);
