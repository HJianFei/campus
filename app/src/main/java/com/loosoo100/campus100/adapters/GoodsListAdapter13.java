 ...
 * @author yang 商品列表适配器
 */
public class GoodsListAdapter13 extends BaseAdapter {
	...
	public GoodsListAdapter13(Context context, List<GoodsInfo> list) {
		this.list = list;
		...
		viewHolder.rl_add.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (list.get(position).getStock() > list.get(position)
					...
					// 更新适配器
					GoodsListAdapter13.this.notifyDataSetChanged();
