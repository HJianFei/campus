...
public class MapLocationActivity extends FragmentActivity implements View.OnClickListener, LocationSource, GeocodeSearch.OnGeocodeSearchListener, AMapLocationListener, AMap.OnCameraChangeListener {
...
//        }
        ...
        switch (v.getId()) {
            ...
            case R.id.send:
                if (mMsg != null) {
                    ...
                    Tool.mLastLocationCallback.onSuccess(mMsg);
                    finish();
                } else {
                    //如果地图地位失败，那么调用
    ...
    public void onRegeocodeSearched(RegeocodeResult regeocodeResult, int i) {
        if (i == 0) {
            if (regeocodeResult != null && regeocodeResult.getRegeocodeAddress() != null) {
                ...
                LogUtils.e("LocationChange", shortAdd + latitude + "----" + longitude);
            } else {
                ToastUtil.showToast(MapLocationActivity.this, "没有搜索到结果");
            }
        } else {
            ToastUtil.showToast(MapLocationActivity.this, "搜索失败,请检查网络");
        }
    }
    ...
    public void onLocationChanged(AMapLocation aMapLocation) {
        if (aMapLocation != null && aMapLocation.getAMapException().getErrorCode() == 0) {
            ...
            LogUtils.e("LocationInit", aMapLocation.getRoad() + aMapLocation.getStreet() + aMapLocation.getPoiName() + latitude + "----" + longitude);
            ...
            public void run() {
                ...
                aMap.animateCamera(update, 1000, new AMap.CancelableCallback() {
                    ...
                    public void onFinish() {
                        aMap.setOnCameraChangeListener(MapLocationActivity.this);
                    }
    ...
    private void setUpLocationStyle() {
        ...
        myLocationStyle.strokeColor(R.color.red_fd3c49);
